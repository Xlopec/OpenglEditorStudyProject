...
import com.epam.opengl.edu.model.Grayscale
...
class GrayscaleTransformation(
    ...
    private val program by lazy {
        context.loadProgram(R.raw.no_transform_vertex, R.raw.frag_grayscale)
    }
    ...
    fun render(
        ...
        GLES31.glUniform1f(grayscaleHandle, 1f - grayscale.value)
